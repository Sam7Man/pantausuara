...
export function applyFilter({ inputData, comparator, filterName }) {
  ...
  if (filterName) {
    inputData = inputData.filter(
      (timses) => timses.nama.toLowerCase().indexOf(filterName.toLowerCase()) !== -1
    );
  }
...
export const headCells = [
  ...
  { id: 'nomor_telepon', numeric: false, disablePadding: false, label: 'No. Telepon' },
  { id: 'kabupaten', numeric: false, disablePadding: false, label: 'Kabupaten' },
