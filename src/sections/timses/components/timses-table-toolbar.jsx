...
import TimsesTableForm from './timses-table-form';


export default function TimsesTableToolbar(props) {
  // eslint-disable-next-line
  const { numSelected, filterName, onFilterName, onDelete, onSearch, selected, rows } = props;
  ...
  // handle form 
  const handleFormOpen = (dialogMode) => {
    setMode(dialogMode);
    setOpen(true);
  };
